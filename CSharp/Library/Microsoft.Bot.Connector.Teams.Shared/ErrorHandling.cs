// 9/17/19 Copied from https://github.com/microsoft/BotBuilder-V3/blob/master/CSharp/Library/Microsoft.Bot.Connector.Shared/ErrorHandling.cs
...
namespace Microsoft.Bot.Connector
{
    ...
    public static class ErrorHandling
    {
        ...
        /// <returns></returns>
        public static async Task<ObjectT> HandleErrorAsync<ObjectT>(this HttpOperationResponse<ObjectT> result)
        {
           if (!result.Response.IsSuccessStatusCode)
           {
               ErrorResponse errorMessage = result.Body as ErrorResponse;
