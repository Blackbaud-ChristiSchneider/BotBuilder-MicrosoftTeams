// 9/17/19 Copied from https://github.com/microsoft/BotBuilder-V3/blob/31f4c001b8b1d7c218abbc5a1406c4c4bf654de3/CSharp/Library/Microsoft.Bot.Connector.Shared/BotAuthenticator.cs
...
namespace Microsoft.Bot.Connector
{
    ...
    public sealed class BotAuthenticator
    {
        ...
        /// ToBotFromChannelOpenIdMetadataUrl  and doesn't disable
        ...
        /// </summary>
        /// <param name="credentialProvider"></param>
        /// <param name="openIdConfigurationUrl"></param>
        /// <param name="disableEmulatorTokens"></param>
        /// <param name="validator"></param>
        ...
        /// activities to MicrosoftAppCredentials.TrustedHostNames if the request is authenticated.
        /// </summary>
        ...
        private async Task<IdentityToken> TryAuthenticateAsyncWithActivity(HttpRequest request,
            IEnumerable<IActivity> activities,
            CancellationToken token)
        {
            if (!AuthenticationHeaderValue.TryParse(request.Headers[HeaderNames.Authorization], out var authHeader) || authHeader == null)
            {
                if (await this.credentialProvider.IsAuthenticationDisabledAsync())
                {
                    return new IdentityToken(true, null);
            ...
            return await TryAuthenticateAsync(toBotFromChannelExtractor, GetToBotFromEmulatorTokenExtractor(), authHeader.Scheme, authHeader.Parameter, token);
        }
            ...
            if (identity != null)
            {
                ...
                else
                {
                    ...
                    if (password != null)
                    {
                        ...
                        identity.AddClaim(new Claim("appPassword", password));
                    }
                }
            }
